      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-800 via-blue-900 to-slate-900 relative overflow-hidden">
        ...
        {message && (
          <div className={`mb-6 p-4 rounded-2xl ${
            message.includes('Error') ? 'bg-red-600/10 backdrop-blur-sm border border-red-500/30' : 'bg-green-600/10 backdrop-blur-sm border border-green-500/30'
          }`}>
